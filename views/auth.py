...
def view_auth():
    ...
    # 2. 渲染左侧背景与内容（通过 CSS 绝对定位锁定）
    st.markdown("""
        <div class="brand-sidebar">
            <div style="font-size: 45px;">💠</div>
            <h1 style="color:white; font-size: 30px; font-weight: 800; margin: 20px 0 10px 0; letter-spacing:-1px;">抖音爆款工场</h1>
    ...
    # 3. 右侧表单逻辑
    # CSS 已强制将此部分 margin-left 设置为 350px
